...
const galleryItems = [
  {
    ...
    subtitle: "Romantic and refined",
    image:
      "https://images.unsplash.com/photo-1496747611176-843222e1e57c?auto=format&fit=crop&w=900&q=80",
  },
  {
    title: "Modern bridal look",
    subtitle: "Clean, elegant, timeless",
    image:
      "https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?auto=format&fit=crop&w=900&q=80",
  },
  {
    title: "Signature styling",
    subtitle: "Personalized to your vision",
    image:
      "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&w=900&q=80",
  },
  {
    title: "Wedding-day details",
    subtitle: "Every moment beautifully considered",
    image:
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 text-3xl font-semibold text-stone-900 sm:text-4xl">
              Inspiration that reflects beauty, poise, and celebration.
            </h2>
          </div>

          <a
            href="/contact"
            className="text-sm font-semibold text-[#8b5e3c] transition hover:text-[#6f462b]"
          >
