      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:items-center">
        <div>
          ...
          <h1 className="mt-4 text-4xl font-semibold leading-tight text-stone-900 sm:text-5xl">
            A curated collection of bridal beauty moments and wedding-day
            details.
          </h1>
          <p className="mt-6 max-w-2xl text-lg leading-8 text-stone-600">
            Explore highlights from recent weddings and styled sessions. Our
            gallery reflects our signature approach: polished artistry, refined
            styling, and intentional presentation.
          </p>
